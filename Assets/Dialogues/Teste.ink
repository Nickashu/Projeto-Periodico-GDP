...
//(Faz o puzzle e retorna  com o salsichão. Corvo desce e se comunica mais claramente)
    *[Dar comida]
        ...
        Hmmm ou és ousado ou completamente louco. O caminho que tu procuras é para lá, após a grande gaiola branca e vermelha. Não digas que eu não te avisei. Cuá. Cuá (sai voando). #character: corvo  #state: corvo_normal
    *[Não fazer nada]
        HAHAHAHAHA saia daqui!. #character: corvo  #state: corvo_normal
    -> END